...

{
...

  {
      ...
      new GLproperty(GL11.GL_LIGHTING, "GL_LIGHTING", "True if lighting is enabled", "lighting/enable", "glIsEnabled()"),
      ...
      new GLproperty(GL11.GL_DEPTH_TEST, "GL_DEPTH_TEST", "Depth buffer enabled", "depth-buffer/enable", "glIsEnabled()"),
